...
class TestAdminController
{
    ...
    private bool $emitRedirects = true;
    ...
    public function handle(bool $emitRedirects = true): array
    {
        $this->emitRedirects = $emitRedirects;
    ...
    {
        if ($this->flashType === null || $this->flashMessage === null) {
            return null;
        }

        return ['type' => $this->flashType, 'text' => $this->flashMessage];
    }
    ...
    private function handlePost(): void
    {
        ...
        try {
            if ($action === 'assign_batch') {
                ...
                $this->setFlash('success', "{$assignedCount} Peserta berhasil didistribusikan.");
                $this->redirectBack();
            ...
            if ($action === 'update_batch') {
                ...
                $this->setFlash('success', 'Data pengawas dan jumlah kuota berhasil diperbarui.');
                $this->redirectBack();
            ...
            if ($action === 'delete') {
                ...
                $this->setFlash('success', 'Distribusi Ujian berhasil direset.');
                $this->redirectClean();
    ...
    {
        $this->redirectTarget = $_SERVER['REQUEST_URI'];

        if (! $this->emitRedirects) {
            return;
        }
    ...
    {
        $this->redirectTarget = strtok($_SERVER['REQUEST_URI'], '?');
