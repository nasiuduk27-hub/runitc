    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        <form method="GET" class="grid grid-cols-1 items-end gap-4 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div>
                ...
                <x-date-input name="date_from" id="sys_audit_date_from" value="{{ $filters['date_from'] }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-200">
            </div>
            <div>
                <label class="mb-1 block text-xs font-semibold text-gray-600">Sampai Tanggal</label>
                <x-date-input name="date_to" id="sys_audit_date_to" value="{{ $filters['date_to'] }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-200">
            </div>
