...
<div class="mx-auto max-w-6xl space-y-6">
    ...
    @if ($result)
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div class="border-b border-gray-100 px-5 py-3 text-sm text-gray-500">{{ $company }} | {{ \App\Services\CreditUnion\CreditUnionPeriod::longLabel($period) }} | {{ number_format($result['rows']->count(), 0, ',', '.') }} anggota</div>
