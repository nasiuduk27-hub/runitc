...
if (! $canManageSupervisor) {
    ...
    exit('Anda tidak memiliki izin untuk menambah data TAD/SPV.');
}
...
<script>
    ...
    function addBankRow() {
        ...
        const bankOptions = `<?php foreach ($bankList as $b) { ?><option value="<?php echo $b['code'] ?>"><?php echo $b['descr'] ?></option><?php } ?>`;
