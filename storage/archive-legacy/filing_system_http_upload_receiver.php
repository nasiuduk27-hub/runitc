...
if ($storagePath === '') {
    sendHttpUploadResponse(400, ['success' => false, 'message' => 'Storage path kosong.']);
}
...
if ($storedExt === '' || in_array($storedExt, $blockedExtensions, true)) {
    sendHttpUploadResponse(400, ['success' => false, 'message' => 'Tipe file storage tidak diizinkan.']);
}
